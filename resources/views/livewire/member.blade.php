<div>
              ...
              <div id="header-carousel" class="carousel slide" data-ride="carousel">
                  <div class="carousel-inner">
                      <div class="carousel-item active" style="height: 410px;">
                          <img class="img-fluid" src="{{url('assets')}}/img/banner (1).jpg" alt="Image">
                      ...
                      <div class="carousel-item" style="height: 410px;">
                          <img class="img-fluid" src="{{url('assets')}}/img/banner (2).jpg" alt="Image">
                          <div class="carousel-caption d-flex flex-column align-items-center justify-content-center">
                              <div class="p-3" style="max-width: 700px;">
                                  <h4 class="text-light text-uppercase font-weight-medium mb-3">Cashback 50% Selamanya</h4>
  ...
  <div class="container-fluid pt-5">
    <div class="text-center mb-4">
      <h2 class="section-title px-5"><span class="px-2">Populer</span></h2>
    </div>
    <div class="row px-xl-5 pb-3">
  ...
  <div class="container-fluid pt-5">
      ...
      <div class="row px-xl-5 pb-3">
                      ...
                      <div class="modal-dialog">
                        <div class="modal-content">
                          ...
                          <div class="modal-footer">
                            <button type="button" class="btn btn-secondary" data-dismiss="modal">Batal</button>
                            @if (in_array($row->id, $product_carts))
                            <button type="button" class="btn btn-primary">Sudah Ditambah</button>
                            @else
                            <button type="button" class="btn btn-primary">Tambah Cart</button>
                            @endif
                          </div>
                        </div>
                      </div>
          ...
          @endforeach
          <div class="col-12 text-center">
            <a href="{{url('products')}}?sort=new" wire:navigate class="btn btn-primary px-4">Lihat Semua</a>
          </div>
      </div>
  </div>
  <!-- Products End -->
